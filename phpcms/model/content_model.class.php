...
class content_model extends model {
	 ...
	 */
	public function add_content($data,$isimport = 0,$content_array = '') {
		//print_r($data);
		//echo "<br>";
		...
		$inputinfo = $content_input->get($data,$isimport,$content_array);
		//echo "abc";print_r($_POST['pictureurls_url']);echo "abc<br>";
		//echo "abc";print_r($_POST['pictureurls_alt']);echo "abc<br>";
		//print_r($inputinfo);
		//exit;
...
// 		echo $_POST['auto_thumb'];
// 		echo "@";
// 		echo $systeminfo['thumb'];
// 		echo "@";
// 		echo $modelinfo['content']."<br>";
		//print_r($modelinfo);
		//echo $modelinfo['pictureurls'];
// 		$pictureurls = $pictureurls ? $pictureurls : stripslashes($modelinfo['pictureurls']);
// 		$data = json_decode($pictureurls,true);
// 		print_r($data);

		//自动提取缩略图
		if(isset($_POST['auto_thumb']) && $systeminfo['thumb'] == '') {
...
// 			//if(preg_match_all("/(src)=([\"|']?)([^ \"'>]+\.(gif|jpg|jpeg|bmp|png))\\2/i", $pictureurls, $matches)) {
// 				$systeminfo['thumb'] = $matches[3][$auto_thumb_no];
// 			}
			//echo "<br>!!!";
			//print_r($matches);
			//echo "11111111111<br>";
			$systeminfo['thumb'] = $data[$auto_thumb_no]['url'];;
			//exit;
		}
